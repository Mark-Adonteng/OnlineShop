...
const Home = () => {
    ...
    const navigateToAnotherPage = () => {
        window.location.href = '/signup.js'; // Replace '/another-page' with the URL of the page you want to navigate to.
      };
    ...
    return (
        ...
        <p>"The number one best Online shop worldwide"</p>
                ...
                <a class="btntwo" onClick={navigateToAnotherPage}>SignUp Here</a>
            </div>
